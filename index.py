...
class Product:
  ...
  def edit_product(self):
    ...
    #Button save data edit
    ttk.Button(self.edit_wind,text = 'Update', command = lambda: self.edit_records(new_name.get(), name, new_price.get(), old_price)).grid(row = 4, column = 2, sticky = W + E)
